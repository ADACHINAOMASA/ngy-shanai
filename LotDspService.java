...
package lot.disp.web.service.sql;
...
import jp.co.nikkeikin.nis.nagoya.lotdsp.bean.*;

import javax.faces.model.SelectItem;
import jp.co.nikkeikin.nis.nagoya.lotdsp.*;
//import jp.co.nikkeikin.nis.nagoya.lotdsp.bean.StaffCommonBean;
//import jp.co.nikkeikin.nis.nagoya.lotdsp.bean.SearchKeyBean;
...
//      "       CASE WHEN D3.AKNO = 1 THEN 'PITRUN��' ELSE NULL END DATAKBN, " +
	"       CASE WHEN D3.AKNO = 1 AND D1.PRJ >= 111 THEN '�{PIT��' WHEN D3.AKNO <> 1 THEN 'HOT��' ELSE NULL END DATAKBN, " +
	"	D1.JUP JUP, " +
        "       CASE WHEN D1.JCD105 = '0' THEN '�P�{��' WHEN D1.JCD105 = '1' THEN '���ʐe' WHEN D1.JCD105 = '2' THEN '�ؕʐe' WHEN D1.JCD105 = '3' THEN '�q�J�[�h'  WHEN D1.JCD105 = '9' THEN '���������O' END JCD105, " +  // 2009/04/22 �ǉ�
	"	D1.SLAB_TEHAIBI YMARK, " +
	"	CASE WHEN D1.NOKI3_RENBAN = '0000  ' THEN NULL ELSE D1.NOKI3_RENBAN END SHIKENNO, " +
	"	CASE WHEN D3.KARIKON_FLG = 1 THEN '�غ�' WHEN D3.KARIKON_FLG = 2 THEN 'P����' ELSE '' END KARIKON, " +
        "	DECODE(NVL(D1.G2,'0'), " +
        "	'0','------------', " +
        "	'1','1:���O�񑩕i', " +
        "	'2','2:�ڋq�w��i', " +
...
//      "       '�Ή��O' DATAKBN, " +
        "       CASE WHEN NVL(D2.PRJ,0) = 0 THEN 'PIT�O' WHEN D2.PRJ >= 111 THEN '��PIT��' ELSE NULL END DATAKBN, " +
        "       D2.JUP JUP, " +
        "       CASE WHEN D2.JCD105 = '0' THEN '�P�{��' WHEN D2.JCD105 = '1' THEN '���ʐe' WHEN D2.JCD105 = '2' THEN '�ؕʐe' WHEN D2.JCD105 = '3' THEN '�q�J�[�h'  WHEN D2.JCD105 = '9' THEN '���������O' END JCD105, " +  // 2009/04/22 �ǉ�
	...
	"	NVL((SELECT M1.TNNAME FROM MAS_TORINO M1 WHERE D1.NONYU = M1.TNCD AND M1.KBN IN ('1', '3')), NULL) NONYU, " +
	"	D1.ENTDATE EDTM,SYSDATE, " +
        "	CASE WHEN D3.KSD is not null THEN '�q��' ELSE '' END DATAKBN, " +
        "	D1.JUP JUP, " +
        "       CASE WHEN D1.JCD105 = '0' THEN '�P�{��' WHEN D1.JCD105 = '1' THEN '���ʐe' WHEN D1.JCD105 = '2' THEN '�ؕʐe' WHEN D1.JCD105 = '3' THEN '�q�J�[�h'  WHEN D1.JCD105 = '9' THEN '���������O' END JCD105, " +  // 2009/04/22 �ǉ�
	"	D1.SLAB_TEHAIBI YMARK, " +
	"	CASE WHEN D1.NOKI3_RENBAN = '0000  ' THEN NULL ELSE D1.NOKI3_RENBAN END SHIKENNO, " +
	...
	"	D1.ENTDATE EDTM,SYSDATE, " +
        "	'�q��' DATAKBN, " +
	"	D1.JUP JUP, " +
        "       CASE WHEN D1.JCD105 = '0' THEN '�P�{��' WHEN D1.JCD105 = '1' THEN '���ʐe' WHEN D1.JCD105 = '2' THEN '�ؕʐe' WHEN D1.JCD105 = '3' THEN '�q�J�[�h'  WHEN D1.JCD105 = '9' THEN '���������O' END JCD105, " +
	"	D1.SLAB_TEHAIBI YMARK, " +
	"	CASE WHEN D1.NOKI3_RENBAN = '0000  ' THEN NULL ELSE D1.NOKI3_RENBAN END SHIKENNO, " +
	"	CASE WHEN D3.KARIKON_FLG = 1 THEN '�غ�' WHEN D3.KARIKON_FLG = 2 THEN 'P����' ELSE '' END KARIKON, " +
        "	DECODE(NVL(D1.G2,'0'), " +
	...
	"	NVL(SAILINKKEY, '')SAILINKKEY,TO_CHAR(MSNO1,'FM0000') || TO_CHAR(MSNOK,'FM00') MSNOK,TO_CHAR(MSNO1,'FM0000') || TO_CHAR(MSNOH,'FM00') MSNOH,TO_CHAR(MSNO1,'FM0000') || TO_CHAR(MSNOS,'FM00') MSNOS,D5.MODDATE, " +
        "       DECODE(JCD112,'0',NULL,'1','��','2','���}','3','�O�s','4','�O��') JCD112, " + // 2016/11/17 �敪�ǉ�
        "       DECODE(HIKIKBN,'0',NULL,'A','A���߯č�','B','B���߯č�','H','������') HIKIKBN, " +
	...
	"AND	D1.JYOTAI = 1 " +
        "UNION ALL " +
	"SELECT " +
	"	D1.LINKKEY,D2.HIJYU,D2.TANW,D2.SW, " +
	...
	"       DECODE(D2.JCD112,'0',NULL,'1','��','2','���}','3','�O�s','4','�O��') JCD112, " + // 2016/11/17 �敪�ǉ�
	...
	"       ,SBK,TRUNC(DECODE(SBSM,'KEN',SH_RYOW,SH_SBW)) SH_SBW " + // 2012-10-08 �ǉ�
	"       ,D4.CYUZO_YY " + //2014/09/25 �ǉ�
	"FROM " +
	"	DAT_JDF_COM_SBOX D1, " +
	"	DAT_LOT_COM_JBOX D2, " +
	...
	"	D1.LINKKEY,D1.BOXNO,SBSM,NVL(SBMMDD,SBYMD) SBMMDD,SBMMDDC,SBX,SBY,SBZ,TRUNC(DECODE(SBSM,'KEN',SH_RYOW,SH_SBW)) SBW,REPLACE(SBPAT,'0','') SBPAT,SBYKY,SBTTY,SBMH, " +
        ...
        "       DECODE(JBSM,NULL,NULL,JBPAT) JBPAT, " +
//        "       DECODE(JBSM,NULL,NULL,TO_CHAR(JBRMH,'9999990.0')) JBRMH, " +
        "       DECODE(JBSM,NULL,NULL,'KEN',TO_CHAR(JBRMH - D5.MODN,'9999990.0'),TO_CHAR(JBRMH,'9999990.0')) JBRMH, " + //2015/10/5 �C��
        "       DECODE(JBSM,NULL,NULL,TO_CHAR(JBBN,'0')) JBBN, " +
        "       DECODE(JBSM,NULL,NULL,TO_CHAR(TAIRYUT,'9999990')) TAIRYUT " +
	"       ,SBK,TRUNC(DECODE(SBSM,'KEN',SH_RYOW,SH_SBW)) SH_SBW " + // 2012-10-08 �ǉ�
	"       ,D4.CYUZO_YY " + //2014/09/25 �ǉ�
...
//        "       DECODE(JBSM,NULL,NULL,TO_CHAR(JBRMH,'9999990.0')) JBRMH, " +
    ...
    // ���̔�ۯď��SQL�@�i�x��� �݌v�ݔ�BOX
    // 2014/09/25 �C��
    private static final String STAFF_PROGRESS_SBOX_QUERY =
        "SELECT * FROM ( " +
	"SELECT " +
	"    D1.LINKKEY,D1.BOXNO,D1.SBSM,NVL(D1.SBMMDD,SBYMD) SBMMDD,D1.SBMMDDC,D1.SBX,D1.SBY,D1.SBZ,D1.SH_SBW SBW,REPLACE(D1.SBPAT,'0','') SBPAT,D1.SBYKY,D1.SBTTY,D1.SBMH,D2.CYUZO_YY " +
	"FROM " +
	...
	"    AND D2.JYOTAI = 2 " +
        "UNION ALL " +
	"SELECT " +
	"    D1.LINKKEY,D1.BOXNO,SBSM,NVL(D1.SBMMDD,SBYMD) SBMMDD,D1.SBMMDDC,D1.SBX,D1.SBY,D1.SBZ,D1.SH_SBW SBW,REPLACE(D1.SBPAT,'0','') SBPAT,D1.SBYKY,D1.SBTTY,D1.SBMH,D2.CYUZO_YY " +
	"FROM " +
	...
	"	 ELSE JBSM END " +
        ...
        "       DECODE(JBSM,NULL,NULL,TO_CHAR(JBZ,'9999990.0')) JBZ, " +
//        "       DECODE(JBSM,NULL,NULL,TO_CHAR(JBRW,'9999990.0')) JBRW, " +
        "       CASE WHEN JBSM is NULL THEN NULL WHEN JBSM = 'KEN' THEN TO_CHAR(JBRW - D4.MODW,'9999990.0') ELSE TO_CHAR(JBRW,'9999990.0') END JBRW, " + //2015/10/6 �C��
        "       DECODE(JBSM,NULL,NULL,JBPAT) JBPAT, " +
//        "       DECODE(JBSM,NULL,NULL,TO_CHAR(JBRMH,'9999990.0')) JBRMH, " +
        "       CASE WHEN JBSM is NULL THEN NULL WHEN JBSM = 'KEN' THEN TO_CHAR(JBRMH - D4.MODN,'9999990.0') ELSE TO_CHAR(JBRMH,'9999990.0') END JBRMH, " + //2015/10/6 �C��
        "       DECODE(JBSM,NULL,NULL,TO_CHAR(JBBN,'0')) JBBN, " +
        "       DECODE(JBSM,NULL,NULL,TO_CHAR(TAIRYUT,'9999990')) TAIRYUT, " +
	"	DECODE(JBSM,NULL,NULL,TO_CHAR(DECODE(round(JBFO,0),NULL,NULL,0,NULL,round(JBFO,0)))) JBFO, " + //2013_01_28�ǉ�
	"	DECODE(JBSM,NULL,NULL,TO_CHAR(DECODE(round(JBBO,0),NULL,NULL,0,NULL,round(JBBO,0)))) JBBO, " + //2013_01_28�ǉ�
	"       DECODE(D1.JBGOOD,NULL,NULL,TO_CHAR(DECODE(round(D1.JBGOOD,0),NULL,NULL,0,NULL,round(D1.JBGOOD,0)))) JBGOOD, " + // 2014/10/29�ǉ�
	"       D3.CYUZO_YY " +
	"FROM " +
	"	DAT_LOT_COM_JBOX D1, " +
...
//        "       DECODE(JBSM,NULL,NULL,TO_CHAR(JBRW,'9999990.0')) JBRW, " +
        ...
        "       DECODE(JBSM,NULL,NULL,JBPAT) JBPAT, " +
//        "       DECODE(JBSM,NULL,NULL,TO_CHAR(JBRMH,'9999990.0')) JBRMH, " +
        "       CASE WHEN JBSM is NULL THEN NULL WHEN JBSM = 'KEN' THEN TO_CHAR(JBRW - D4.MODN,'9999990.0') ELSE TO_CHAR(JBRMH,'9999990.0') END JBRMH, " +  //2015/10/6�C��
        "       DECODE(JBSM,NULL,NULL,TO_CHAR(JBBN,'0')) JBBN, " +
        "       DECODE(JBSM,NULL,NULL,TO_CHAR(TAIRYUT,'9999990')) TAIRYUT, " +
    ...
    private static final String STAFF_MANUFACTURE_QUERY =
        "SELECT * FROM ( " +
	"SELECT " +
        "       D1.LINKKEY,SKIGO,SX,SY,SZ,STW,JUP,SW,H_MENS,MENW,PITJ,PIT,PRJ,ATJ,HOTJ,CROSS1,HBCOD,F1X,FX,HY,HZ, " +
...
// @E 2011/02/25
	...
	"AND	D1.JYOTAI = 1 " + //���
        "UNION ALL " +
        "SELECT " +
        "       D1.LINKKEY,D2.SKIGO,D2.SX,D2.SY,D2.SZ,D2.STW,D2.JUP,D2.SW,D2.H_MENS,D2.MENW, " +
...
// @E 2011/02/25 MOD
	...
	"	D1.LINKKEY = D2.LINKKEY " +
	"AND	D1.CYNO = D3.CN(+) " +
	"AND	D1.CYUZO_YY = D3.CYUZO_YY(+) " + // �ǉ� 2014/09/24
	"AND 	D3.CNB = D4.CYUBAN(+) " +
	"AND	D3.CYUZO_YY = D4.CYUZO_YY(+) " + // �ǉ� 2014/09/24
	"AND	D1.JYOTAI = 1 " +
        "UNION ALL " +
	...
	*/
	...
	"SELECT " +
	"	LINKKEY,QCCOD01,QCCOD02,QCCOD03,QCCOD04,QCCOD05,QCCOD06,QCCOD07,QCCOD08,QCCOD09,QCCOD10,QCCOD11,QCCOD15, " +
	...
	"	D1.LINKKEY = D2.LINKKEY " +
	"AND	D1.CYNO = D3.CN(+) " +
	"AND	D1.CYUZO_YY = D3.CYUZO_YY(+) " + // �ǉ� 2014/9/24
	"AND 	D3.CNB = D4.CYUBAN(+) " +
	"AND 	D3.CYUZO_YY = D4.CYUZO_YY(+) " + // �ǉ� 2014/9/24
	"AND 	D1.JYOTAI = 1 " +
        "UNION ALL " +
	"SELECT " +
	"	D1.LINKKEY,QCCOD01,QCCOD02,QCCOD03,QCCOD04,QCCOD05,QCCOD06,QCCOD07,QCCOD08,QCCOD09, " +
	...
	"	'0' SELCHECK,LINKKEY,D1.INPUTSEQ,JYURYO1,JYURYO2,HABA1,HABA2,HABA3,TAKECD, " +
        "       DECODE(HABAKBN1,'1','OS','2','DS','3','����','') HABAKBN1, " +
        "       DECODE(HABAKBN2,'1','OS','2','DS','3','����','') HABAKBN2, " +
        "       DECODE(HABAKBN3,'1','OS','2','DS','') HABAKBN3, " +
        "       DECODE(TAKEKBN1,'1','�� ','2','�� ','3','�� ','4','�� ','5','�� ','6','�� ','') || " +
        "       DECODE(TAKEKBN2,'1','�� ','2','�� ','3','�� ','4','�� ','5','�� ','6','�� ','') || " +
        "       DECODE(TAKEKBN3,'1','�� ','2','�� ','3','�� ','4','�� ','5','�� ','6','�� ','') TAKEKBN, " +
	"       DECODE(MENKBN1,'1','�� ','2','�� ','') || " +
	"       DECODE(MENKBN2,'1','�� ','2','�� ','') MENKBN, " +
        "       NVL(TAKE3,0) || ' / ' || NVL(TAKE2,0) || DECODE(TAKECD,'R',' ��','D',' �o','M',' �o','S',' ��','') TAKE, " +
        "	PITCH,TAKE1, " +
        "	KOCYORYOKU,TAIRYOKU,NOBI,HOKOSEI,DECODE(MAGEKBN,'1','����','2','�ُ�','') MAGEKBN,ERICHSEN,CLADRITSU,LCHI, " +
    ...
    //ICAS��ۯď��SQL
    // @2011/01/21 �ۗ��敪(�ޔ�)��ǉ�
    // @2015/02/16 �����Җ�(JUNO202)�ǉ�
    private static final String ICAS_QUERY =
        "SELECT * FROM ( " +
        "SELECT " +
        "   '2' LOT_FLAG,D1.LINKKEY,LTNO,DECODE(KNNO,'0000000000',NULL,KNNO) KNNO,DECODE(CYNO,'0000000000',NULL,CYNO) CYNO,JUNO,ZAIC02,JCD201, " +
	"   DECODE(JUNO202,'000000000',NULL,JUNO202) JUNO202, " +
        "   DECODE(SUBSTR(JCD201,1,1),'1','��','2','����','3','���') KJYO, " +
	...
	*/
        ...
        "   DECODE(JCD114,'1','�ָ ','----')|| DECODE(JCD118,'1','��� ','----') || NVL(SCHEDSM,'----') YOJYO, " +
        "   CASE " +
        ...
        "   CASE WHEN JCD112 IN ('1','2','3','4') THEN NVL(TO_CHAR(NOKIYMD,'YY/MM/DD'),'--------') ELSE '--------' END SYDT, " + // 2017/4/27 3,4�敪��ǉ�
        "   '----------' MAGMSG, " +
        "   TO_CHAR(SYSDATE,'HH24:MI') HHMM, " +
        "   NVL(JBCD,'----') JBCD, " +
        "   BUCODE b, " +
//	"   DECODE(KARIKON_FLG, '1', '�غ�', '') KARIKON_FLG, " +
	"   DECODE(KARIKON_FLG, '1', '�غ�', '2' , 'P���', '') KARIKON_FLG, " +
        "   SCHEDSM, " +
        "   CHOSEI, " +
        "   NVL(JHF1X,0) HOTZ,  " +
        "   NVL(JHFTMP,0) HT1, " +
        ...
        "   ) SKSBSM, " +
//        "       DECODE(KSD,NULL,NULL,'( ' || TO_CHAR(KSD,'YY/MM/DD') || ' ��خ� )') SKSBSM, " +
        "   SAI1_FRMDTM, " +
	...
	"   , HOKBN_SAVE "   + // @2011/01/21 �ۗ��敪(�ޔ�)��ǉ�
	"   , GIJUTSU_HOKBN "+
/* --- �e�X�g�p --- */
/*
	"   , '' JRFLG " +   // @2012/12/10 Y.MORIYAMA ��������ǉ�
	"   , TO_CHAR(NULL) JRSTDT "  +
	"   , TO_CHAR(NULL) JREDDT "  +
 ...
 */
 /* �{�ԗp */
	"   , D6.JRFLG " +   // @2012/12/10 Y.MORIYAMA ��������ǉ�
...
/**/
	...
	"   '-----' RYOU,'-----' RYOW2,'-----' RYON,D1.JCD112,D1.JCD114,D1.JCD118,D1.NOKIYMD,D1.PITMAG_FLG,D1.BUCODE,D1.JCD106, " +
        ...
        "   '--' BU,'-----' BR,'--' TA,'-----' TR,'-----' RYOW, " +
        "   DECODE(D1.JCD114,'1','�ָ ','----')|| DECODE(D1.JCD118,'1','��� ','----') || '----' YOJYO, " +
        "   CASE " +
        "       WHEN D10.SBMMDD = D7.SBMMDD THEN '0.0' " +
        "       WHEN (D10.SBMMDDC < D7.SBMMDDC) AND (D7.SBMMDDC - D10.SBMMDDC = 2) THEN TO_CHAR(NVL(D10.SBMMDD-1-D7.SBMMDD,0),'9990.0') " +
        "       ELSE TO_CHAR(NVL(D10.SBMMDD-D7.SBMMDD,0),'9990.0') " +
...
/**/
  	...
  	"   MAS_YOTO M2 " +
        ...
        "UNION ALL " +
        "SELECT " +
        "   '1' LOT_FLAG,D1.LINKKEY,LTNO,DECODE(D2.KNNO,'0000000000',NULL,D2.KNNO) KNNO,DECODE(CYNO,'0000000000',NULL,CYNO) CYNO,JUNO,ZAIC02,JCD201, " +
	"   DECODE(JUNO202,'000000000',NULL,JUNO202) JUNO202, " +
        "   DECODE(SUBSTR(JCD201,1,1),'1','��','2','����','3','���') KJYO, " +
        "   DECODE(SLAB_TEHAIBI,NULL,NULL,'Y(' || DECODE(TO_CHAR(SLAB_TEHAIBI,'MM'),'10','X','11','Y','12','Z',SUBSTR(TO_CHAR(SLAB_TEHAIBI,'MM'),2,1)) || TO_CHAR(SLAB_TEHAIBI,'DD') || ')') TEHAI, " +
        "   DECODE(E_MARK,'E','E') EMARK, " +
	...
	*/
        ...
        "   DECODE(D2.A11,'K',DECODE(D11.JBSM,'KEN',DECODE(NVL(D1.SH_RYOW,0),0,'-----',TO_CHAR(NVL(D11.JBRW,0)*100/D1.SH_RYOW,'9990.0')),'-----'),'-----') TR, " +
        "   DECODE(NVL(D11.JBRW,0),0,'-----',D11.JBRW) RYOW, " +
        "   DECODE(JCD114,'1','�ָ ','----')|| DECODE(JCD118,'1','��� ','----') || '----' YOJYO, " +
        "   CASE " +
        "       WHEN D10.SBMMDD = D7.SBMMDD THEN '0.0' " +
        "       WHEN (D10.SBMMDDC < D7.SBMMDDC) AND (D7.SBMMDDC - D10.SBMMDDC = 2) THEN TO_CHAR(NVL(D10.SBMMDD-1-D7.SBMMDD,0),'9990.0') " +
        "       ELSE TO_CHAR(NVL(D10.SBMMDD-D7.SBMMDD,0),'9990.0') " +
...
/**/
        ...
        "AND	D1.BENO = D11.BOXNO(+) " +
        "AND	D1.CYNO = D12.CN(+) " +
	"AND	D1.CYUZO_YY = D12.CYUZO_YY(+) " + // �ǉ� 2014/09/
	"AND	D1.JYOTAI = 2 " +
	// 2014/09/25 �ǉ� ��
        "UNION ALL " +
        "SELECT " +
	...
	"SELECT " +
        ...
        "	SBY, " +
        "	SBZ, " +
        "	(DECODE(SUBSTR(SBSM,1,2),'L-',DECODE(INSTR(SBPAT,'�',1),0,NULL,'�')) || " +
        "        DECODE(NVL(INSTR(SBPAT,'�',1),0) + NVL(INSTR(SBPAT,'�',1),0),0,NULL,'@')) SBPAT, " +
        "	SBMH, " +
        "	SH_SBW, " +
...
//        "	TRUNC(DECODE(D2.JBSM,NULL,DECODE(SBSM,'KEN',SH_RYOW,SH_SBW),JBRW),0) JBRW, " +
        "	TRUNC(CASE WHEN JBSM is NULL THEN DECODE(SBSM,'KEN',SH_RYOW,SH_SBW) WHEN JBSM = 'KEN' THEN JBRW - D5.MODW ELSE JBRW END) JBRW, " + //2015/10/5 �C��
//        "	JBRMH, " +
	"	TRUNC(CASE WHEN JBSM = 'KEN' THEN JBRMH - D5.MODN ELSE JBRMH END) JBRMH, " + //2015/10/5 �C��
	...
	"	SBMH, " +
	"	SH_SBW, " +
	"	TRUNC(DECODE(SBSM,'KEN',SH_RYOW,SH_SBW)) SBW, " + //2012-10-11 ���l�؂�グ
	"	'S' PROC_KBN, " +
	"	'' A11, " +
	"	SBSM JBSM, " +
	"	TRUNC(DECODE(SBSM,'KEN',SH_RYOW,SH_SBW)) JBRW, " + //2012-10-11 ���l�؂�グ
	"	0 JBRMH, " +
	"	SBPAT JBPAT, " +
	"	TO_DATE(NULL) JBEDTM, " +
...
//        "        DECODE(NVL(INSTR(SBPAT,'�',1),0) + NVL(INSTR(SBPAT,'�',1),0),0,NULL,'@')) SBPAT, " +
	...
	// 2012-09-28 �ݔ��ǉ�-end-
        "	 ELSE NVL(JBSM,SBSM) END " +
        "	) JBSM, " +
//        "	TRUNC(DECODE(D2.JBSM,NULL,DECODE(SBSM,'KEN',SH_RYOW,SH_SBW),JBRW)) JBRW, " + //2012-10-11 ���l�؂�グ
        "	TRUNC(CASE WHEN JBSM is NULL THEN DECODE(SBSM,'KEN',SH_RYOW,SH_SBW) WHEN JBSM = 'KEN' THEN JBRW - D5.MODW ELSE JBRW END) JBRW, " + //2015/10/5 �C��
...
//        "	JBRMH, " +
    ...
    public static String getCladKawazaiQuery() {
        ...
        bld.append(    " AND Z1.CYUZO_YY = J1.CYUZO_YY "); // 2014/09/25 �ǉ�
        ...
        bld.append(    " AND Z2.CYUZO_YY = J2.CYUZO_YY "); // 2014/09/25 �ǉ�
	...
	bld.append(    " AND J2.JYOTAI = 1 ");
        ...
        bld.append(    " AND Z3.CYUZO_YY = J3.CYUZO_YY "); // 2014/09/25 �ǉ�
        ...
        bld.append(    " AND Z4.CYUZO_YY = J4.CYUZO_YY "); // 2014/09/25 �ǉ�
        ...
        bld.append(    " AND Z5.CYUZO_YY = J5.CYUZO_YY "); // 2014/09/25 �ǉ�
        ...
        bld.append(    " AND Z6.CYUZO_YY = J6.CYUZO_YY "); // 2014/09/25 �ǉ�
        ...
        bld.append(    " AND Z7.CYUZO_YY = J7.CYUZO_YY "); // 2014/09/25 �ǉ�
	...
	bld.append(    " AND J7.LINKKEY = ? ");
        ...
        bld.append(    " AND Z8.CYUZO_YY = J8.CYUZO_YY "); // 2014/09/25 �ǉ�
	...
	bld.append("		DECODE(SHODON_FLG1,'0','','1','1 CAI�w��','2','2 CAI�D��','3','3 �o�b�`�w��','4','4 �o�b�`�D��',SHODON_FLG1) SHODON_FLG1, ");
	bld.append("		DECODE(SHODON_FLG2,'0','','1','1 CAF�w��','2','2 CAF�D��','3','3 �o�b�`�w��','4','4 �o�b�`�D��',SHODON_FLG2) SHODON_FLG2, ");
	...
	bld.append("		DECODE(PKBN,'0','','1','��','2','��','') PKBN, ");
...
*/
	...
	bld.append("		DAT_JDF_COM D4 "); // 2014/09/30 �ǉ�
	bld.append("	WHERE ");
	bld.append("		    D1.LINKKEY = D2.LINKKEY(+) ");
...
*/
	...
	bld.append("		DAT_R_LOT_COM_JBOXEX D3, "); // 2014/09/25 �C��
	bld.append("		DAT_R_JDF_COM D4 "); // 2014/09/30 �ǉ�
	bld.append("	WHERE ");
	bld.append("		    D1.LINKKEY = D2.LINKKEY(+) ");
	bld.append("		AND D1.BOXNO   = D2.BOXNO(+) ");
	bld.append("		AND D1.LINKKEY = D3.LINKKEY(+) ");
	...
	bld.append("		DAT_S_JDF_COM D4 "); // 2014/09/30 �ǉ�
	bld.append("	WHERE ");
	bld.append("		    D1.LINKKEY = D2.LINKKEY(+) ");
	bld.append("		AND D1.TOROKUDATE = D2.TOROKUDATE(+) ");
	bld.append("		AND D1.BOXNO = D2.BOXNO(+) ");
...
//	  dataSource.setUrl( "jdbc:oracle:thin:@nlmfangynavd:1521:OPNWDR1"); // ***�{��***
//	  dataSource.setUrl( "jdbc:oracle:thin:@nlmfangydev1:1521:OPNWDD1"); //TEST
	  dataSource.setUrl( "jdbc:oracle:thin:@nlmfangysysd:1521:OPNMDR1"); // ���JDB
//	  dataSource.setUrl( "jdbc:oracle:thin:@nlmfangydev1:1521:OPNMDD1");

        dataSource.setUsername( "NLM");
        dataSource.setPassword( "NLM4928144");
    ...
    private class FindStaffProgressJBoxQuery extends MappingSqlQuery {
        public FindStaffProgressJBoxQuery(DataSource ds) {
            ...
            super.declareParameter(new SqlParameter("CYUZO_YY", Types.DECIMAL));
	    //System.out.println("@SQL(�i�x��� ����):" + STAFF_PROGRESS_JBOX_QUERY);
            compile();
        }
        public Object mapRow(ResultSet rs, int rowNumber) throws SQLException {
    ...
    private class FindIcasBoxQuery extends MappingSqlQuery {
        public FindIcasBoxQuery(DataSource ds) {
            ...
            super.declareParameter(new SqlParameter("LINKKEY", Types.VARCHAR));
            super.declareParameter(new SqlParameter("CYUZO_YY", Types.DECIMAL));
	    //System.out.println("ICAS�ݔ�:"+ICAS_BOX_QUERY);
            compile();
        }
        public Object mapRow(ResultSet rs, int rowNumber) throws SQLException {
    ...
    private class FindCFInfoBoxQuery extends MappingSqlQuery {
        public FindCFInfoBoxQuery(DataSource ds) {
            ...
            super.declareParameter(new SqlParameter("LINKKEY", Types.VARCHAR));
            super.declareParameter(new SqlParameter("CYUZO_YY", Types.DECIMAL));
	    //System.out.println("�ē�SQL�F"+getCFShodonQuery());
            compile();
        }
        public Object mapRow(ResultSet rs, int rowNumber) throws SQLException {
    ...
    public SearchKeyBean FindSearchKeyInfo(Map params) throws SQLException,NotFoundException {
        ...
        if (lst.size() == 0)
            throw new NotFoundException();
        SearchKeyBean searchKeyInfo = (SearchKeyBean)lst.get(0);  // �ŏ��̂P���ڂ���
        // ���ʂ��i�[
    ...
    //���̔�ۯď��擾ҿ��� ���ʏ��
    public StaffCommonBean FindStaffCommonInfo(String linkkey,BigDecimal cyuzoYy) throws SQLException,NotFoundException {
	DriverManagerDataSource dataSource = ConnectDataSource();
        //���̔�ۯď��SQL�̌��� �������
	...
	Object[] params = new Object[]{linkkey,cyuzoYy};
        ...
        StaffCommonBean staffCommonInfo = (StaffCommonBean)lst.get(0);  // �ŏ��̂P���ڂ���
	...
	//System.out.println("," + linkkey + "," + cyuzoYy);
        ...
        //���̔�ۯď��SQL�̎��s ����
        List lst1 = query1.execute(linkkey);
        // 0������
        if (lst1.size() == 0){
	    //System.out.print("@�G���[3");
            throw new NotFoundException();
	}
        StaffProgressBean staffProgressInfo = (StaffProgressBean)lst1.get(0);  // �ŏ��̂P���ڂ���

        //���̔�ۯď��SQL�̌��� �i�x��� �ݔ�BOX
	...
	Object[] paramsSbox = new Object[]{linkkey,cyuzoYy}; //ADD
        ...
        //���̔�ۯď��SQL�̌��� �i�x��� �݌v�ݔ�BOX
        FindStaffProgressSBoxQuery query3 = new FindStaffProgressSBoxQuery(dataSource);
        // �ݔ�BOX���SQL�̎��s
	Object[] paramsSbox2 = new Object[]{linkkey,cyuzoYy}; //ADD
        List lst3 = query3.execute(paramsSbox2);  //execute(linkkey) ����ύX
        // 0������
        if (lst3.size() == 0){
    ...
    //���̔�ۯď��擾ҿ��� �������
    public StaffManufactureBean FindStaffManufactureInfo(String linkkey) throws SQLException,NotFoundException {
        DriverManagerDataSource dataSource = ConnectDataSource();
        //���̔�ۯď��SQL�̌��� �������
	   ...
	   // System.out.print("@�G���[7");
        ...
        StaffManufactureBean ��taffManufactureInfo = (StaffManufactureBean)lst.get(0);  // �ŏ��̂P���ڂ���

        // ���ʂ��i�[
        return ��taffManufactureInfo;

    }

    //���̔�ۯď��擾ҿ��� �������
    public StaffTestBean FindStaffTestInfo(String linkkey) throws SQLException,NotFoundException {
        DriverManagerDataSource dataSource = ConnectDataSource();
        //���̔�ۯď��SQL�̌��� �������
        FindStaffTestQuery query = new FindStaffTestQuery(dataSource);
        //���̔�ۯď��SQL�̎��s �������
        Object[] params = new Object[]{linkkey, linkkey, linkkey};
        List lst = query.execute(params);
        // 0������
        if (lst.size() == 0){
        ...
        StaffTestBean staffTestInfo = (StaffTestBean)lst.get(0);  // �ŏ��̂P���ڂ���
    ...
    public StaffQualityBean FindStaffQualityInfo(String linkkey) throws SQLException,NotFoundException {
        ...
        for(int i=0; i<lst.size(); i++) {
            jp.co.nikkeikin.nis.nagoya.lotdsp.bean.StaffQualityBoxBean bean = (jp.co.nikkeikin.nis.nagoya.lotdsp.bean.StaffQualityBoxBean)lst.get(i);
            if (i == 0) {
                bean.setSELECTED("1");
            } else {
                bean.setSELECTED("0");
	...
	IcasBean icasInfo = (IcasBean)lst.get(0);  // �ŏ��̂P���ڂ���
	...
	for(int i=0; i<lst2.size(); i++) {
	    jp.co.nikkeikin.nis.nagoya.lotdsp.bean.IcasBoxBean bean = (jp.co.nikkeikin.nis.nagoya.lotdsp.bean.IcasBoxBean)lst2.get(IcasBoxSize);
	    // �݌v�ݔ���=ANF AND ����t���O = 1 �̏ꍇ��ƃp�^�[��SBSM��"J"���Z�b�g
     ...
     * 2011/07/05 add
     */
    public CladInfoBean FindCladInfo(String linkkey) throws SQLException, NotFoundException {
        ...
        // SQL�̎��s
	Object[] params = new Object[]{linkkey, linkkey, linkkey, linkkey, linkkey, linkkey, linkkey, linkkey};
        List lst2 = query2.execute(params);
        // 0������
        if (lst2.size() > 0) {
     ...
     * 2012/12/14 add
     */
    public CFInfoBean FindCFInfo(String linkkey,BigDecimal cyuzoYy) throws SQLException, NotFoundException {
        ...
        // SQL�̎��s
	System.out.println("CF_SQL:" + linkkey + "," + cyuzoYy); //test
	Object[] params = new Object[]{linkkey, cyuzoYy};
        List lst2 = query2.execute(params);
        // 0������
        if (lst2.size() > 0) {
