    ...
    var newController = function (
        ...
        $scope.action = {
        	...
        	init:function(){
        		...
        		//設計・実績データの設定
        		$scope.action.setStaffProgressBoxInfosData();
        	}
        	//共通データの設定
        	...
        	//設計・実績データの設定
    		,setStaffProgressBoxInfosData:function(){
    			//設計
    			$scope.staffProgressBoxInfos = JSON.parse(localStorage.getItem(lotInfoStorage)).staffProgressBean.staffProgressBoxInfos;
    			//明細の背景色を偶数行・奇数行で変更する
    			...
    			//実績
    			$scope.staffProgressJBoxInfos = JSON.parse(localStorage.getItem(lotInfoStorage)).staffProgressBean.staffProgressJBoxInfos;
    			//明細の背景色を偶数行・奇数行で変更する
