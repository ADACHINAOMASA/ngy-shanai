package lotdsp.common.msg.tantosha;
...
public class TantoshaInfo { 
	...
	private String jigyoshoMei;
	private String bumonMei;

	protected String shoninKengen;
	...
	//------------------------------------------------------------------------Getter/Setter
	public String getJigyoshoMei() {
		return jigyoshoMei;
	}

	public void setJigyoshoMei(String jigyoshoMei) {
		this.jigyoshoMei = jigyoshoMei;
	}
	...
	public void setShoninKengen(String shoninKengen) {
		this.shoninKengen = shoninKengen;
	}
