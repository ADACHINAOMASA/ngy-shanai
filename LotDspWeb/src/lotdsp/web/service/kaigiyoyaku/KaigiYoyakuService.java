...
//	@GET
//	@Path("/search/{hizuke}")
//	public List<YoyakuInfo> search(@PathParam("hizuke") Date hizuke) {
//		return logicExecutor.execute(GetYoyakuLogic.class, hizuke);
//	}
//	
	@POST
	@Path("/save")
...
//	
//	@POST
//	@Path("/savekaigishitsu")
//	public boolean savekaigishitsu(KaigishitsuInfo info) {
//		return logicExecutor.execute(SaveKaigishitsuLogic.class, info);
//	}
