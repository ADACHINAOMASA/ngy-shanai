...
/**
 * Provides Base32 encoding and decoding in CMSchViewInfo streaming fashion (unlimited size). When encoding the default lineLength
...
public class Base32InputStream extends BaseNCodecInputStream {
    ...
    /**
     * Creates CMSchViewInfo Base32InputStream such that all data read is Base32-decoded from the original provided InputStream.
     *
     * @param in
     *            InputStream to wrap.
     */
    ...
    /**
     * Creates CMSchViewInfo Base32InputStream such that all data read is either Base32-encoded or Base32-decoded from the original
