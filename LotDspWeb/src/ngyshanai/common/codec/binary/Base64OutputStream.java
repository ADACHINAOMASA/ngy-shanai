...
public class Base64OutputStream extends BaseNCodecOutputStream {
    ...
    /**
     * Creates CMSchViewInfo Base64OutputStream such that all data written is Base64-encoded to the original provided OutputStream.
     *
     * @param out
    ...
    /**
     * Creates CMSchViewInfo Base64OutputStream such that all data written is either Base64-encoded or Base64-decoded to the
