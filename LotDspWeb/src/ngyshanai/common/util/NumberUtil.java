...
public class NumberUtil {
	...
	/**
	 * ゼロの場合はNULLを返す。 Nullの扱い→Null、スペースの扱い→なし
	 *
	 * @param val
	 *            数値
	 * @return 文字列
	...
	public static boolean hasNoValue(BigDecimal val) {
		return !hasValue(val);
	}

	public static void initNumber(Object bean) {
		PropertyDescriptor[] props = PropertyUtils.getPropertyDescriptors(bean);
		for (int i = 0; i < props.length; i++) {
			if ("BigDecimal".equals(props[i].getPropertyType().getSimpleName())) {
				try {
					BeanUtils.setProperty(bean, props[i].getName(), BigDecimal.ZERO);
	...
	public static void main(String[] arg) {
		...
		System.err.println(isBigger(null, null));
		System.err.println(isBigger(null, BigDecimal.ONE));
		System.err.println(isBigger(BigDecimal.ONE, null));
		System.err.println(isBigger(BigDecimal.ONE, BigDecimal.ONE));
		System.err.println(isBigger(BigDecimal.ONE, BigDecimal.ZERO));
				
		System.err.println(isSmaller(null, null));
		System.err.println(isSmaller(null, BigDecimal.ONE));
		System.err.println(isSmaller(BigDecimal.ONE, null));
		System.err.println(isSmaller(BigDecimal.ONE, BigDecimal.ONE));
		System.err.println(isSmaller(BigDecimal.ZERO, BigDecimal.ONE));
