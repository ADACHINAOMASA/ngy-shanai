...
import ngyshanai.domain.nagoya.log.Log;
import ngyshanai.domain.nagoya.log.LogFactory;
import ngyshanai.domain.nagoya.util.DateUtil;
import ngyshanai.domain.nagoya.util.NumberUtil;
