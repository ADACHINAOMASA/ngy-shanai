(function () {
	...
	var name = 'GaichusakiListModalController';
    ...
    var ListModalController = function (
		...
		// 初期値 ------------------------------------------------------------------------------ ↓
		// タイトル
		$scope.title = SysConst.gaichusaki.ichiran.title;
		// 入力情報
		$scope.input = input || {};
		//ヘッダー情報
		$scope.header = header || {};
		...
		$scope.records = [];
		// GridStorageName作成
		var gridStorageName = $scope.header.userProfile.userId + "_" + SysConst.gaichusaki.ichiran.gridStorageName;
		// 初期値 ------------------------------------------------------------------------------ ↑
