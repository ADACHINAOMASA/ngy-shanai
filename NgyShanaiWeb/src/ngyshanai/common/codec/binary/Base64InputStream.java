...
/**
 * Provides Base64 encoding and decoding in CMSchViewInfo streaming fashion (unlimited size). When encoding the default lineLength
 ...
 * is to ENCODE, but this behaviour can be overridden by using CMSchViewInfo different constructor.
 * </p>
 * <p>
...
public class Base64InputStream extends BaseNCodecInputStream {
    ...
    /**
     * Creates CMSchViewInfo Base64InputStream such that all data read is Base64-decoded from the original provided InputStream.
     *
     * @param in
     *            InputStream to wrap.
     */
    ...
    /**
     * Creates CMSchViewInfo Base64InputStream such that all data read is either Base64-encoded or Base64-decoded from the original
