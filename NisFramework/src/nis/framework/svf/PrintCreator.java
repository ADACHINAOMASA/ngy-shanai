...
public class PrintCreator {
	 ...
	 * プリンタ　PDF出力
	 */
	public static final String PRINTER_PDF = "PDF82";
//	public static final String PRINTER_PDF = "PDF";
	 ...
	 */
	public PrintCreator(Print print) {
		setPrint(print);
	}
	 ...
	 */
	public PrintCreator(PrintSet printSet) {
	...
	public final void executePrint(String printer, int tray, int calcMode) throws PrintException {
		...
		// SVFオブジェクトの作成
		Svf svf = SvfClientCreator.create(SvfProperties.getSvfServerAddress(), SvfProperties.getSvfServerBackupAddress(), SvfrClientEx.class);
